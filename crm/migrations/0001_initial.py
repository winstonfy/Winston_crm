# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2020-01-02 15:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('course', models.CharField(choices=[('Block', '智能积木'), ('Scratch', 'scratch编程'), ('Car', '智能小车'), ('Python', 'python编程'), ('Html', 'HTML网页编程'), ('Aircraft ', '无人机')], max_length=64, verbose_name='课程名称')),
                ...
                ('class_type', models.CharField(blank=True, choices=[('fri', '周五班'), ('sat', '周六班'), ('sun', '周日班')], max_length=64, null=True, verbose_name='班额及类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('qq', 'qq群'), ('referral', '内部转介绍'), ('website', '官方网站'), ('baidu_ads', '百度推广'), ('office_direct', '直接上门'), ('WoM', '口碑'), ('public_class', '公开课'), ('website_luffy', '智酷官网'), ('others', '其它')], default='qq', max_length=64, verbose_name='客户来源')),
                ('course', multiselectfield.db.fields.MultiSelectField(choices=[('Block', '智能积木'), ('Scratch', 'scratch编程'), ('Car', '智能小车'), ('Python', 'python编程'), ('Html', 'HTML网页编程'), ('Aircraft ', '无人机')], max_length=39, verbose_name='咨询课程')),
                ('class_type', models.CharField(choices=[('fri', '周五班'), ('sat', '周六班'), ('sun', '周日班')], default='fulltime', max_length=64, verbose_name='班级类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.CharField(blank=True, choices=[('Block', '智能积木'), ('Scratch', 'scratch编程'), ('Car', '智能小车'), ('Python', 'python编程'), ('Html', 'HTML网页编程'), ('Aircraft ', '无人机')], default='N/A', max_length=64, null=True, verbose_name='课程名')),
                ('class_type', models.CharField(blank=True, choices=[('fri', '周五班'), ('sat', '周六班'), ('sun', '周日班')], default='N/A', max_length=64, null=True, verbose_name='班级类型')),
                ('delete_status', models.BooleanField(default=False, verbose_name='删除状态')),
